...
uint get_total_signal_no() {return 7243873;}

uint get_number_of_components() {return 6674;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 1506241;}
...
ctx->componentMemory[coffset].componentName = componentName;
ctx->componentMemory[coffset].idFather = componentFather;
ctx->componentMemory[coffset].subcomponents = new uint[2064]{0};
}
...
uint aux_create = 0;
int aux_cmp_num = 0+ctx_index+1;
uint csoffset = mySignalStart+19488;
...
int aux_cmp_num = 2048+ctx_index+1;
uint csoffset = mySignalStart+37920;
...
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * ((8 * Fr_toInt(&lvar[2])) + Fr_toInt(&lvar[3]))) + 2080)];
// load src
...
if(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[2])) + 2080)];
// load src
// end load src
Fr_copy(aux_dest,&circuitConstants[2]);
}
...
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[19]); // line circom 26
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[3];
// load src
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[3])) + 2080)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * Fr_toInt(&lvar[3])) + 1600)];
// load src
Fr_sub(&expaux[2],&lvar[2],&circuitConstants[2]); // line circom 37
cmp_index_ref_load = ((1 * Fr_toInt(&expaux[2])) + 2048);
cmp_index_ref_load = ((1 * Fr_toInt(&expaux[2])) + 2048);
Fr_mul(&expaux[4],&lvar[2],&circuitConstants[66]); // line circom 37
Fr_add(&expaux[3],&expaux[4],&lvar[3]); // line circom 37
Fr_add(&expaux[1],&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&expaux[2])) + 2048)]].signalStart + ((1 * Fr_toInt(&lvar[3])) + 0)],&signalValues[mySignalStart + ((1 * Fr_toInt(&expaux[3])) + 2080)]); // line circom 37
Fr_sub(&expaux[5],&lvar[2],&circuitConstants[2]); // line circom 38
cmp_index_ref_load = ((1 * Fr_toInt(&expaux[5])) + 2048);
cmp_index_ref_load = ((1 * Fr_toInt(&expaux[5])) + 2048);
Fr_mul(&expaux[3],&circuitConstants[4],&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&expaux[5])) + 2048)]].signalStart + ((1 * Fr_toInt(&lvar[3])) + 0)]); // line circom 38
Fr_mul(&expaux[5],&lvar[2],&circuitConstants[66]); // line circom 38
Fr_add(&expaux[4],&expaux[5],&lvar[3]); // line circom 38
Fr_mul(&expaux[2],&expaux[3],&signalValues[mySignalStart + ((1 * Fr_toInt(&expaux[4])) + 2080)]); // line circom 38
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * Fr_toInt(&lvar[3])) + 1600)];
// load src
Fr_sub(&expaux[0],&lvar[2],&circuitConstants[2]); // line circom 40
cmp_index_ref_load = ((1 * Fr_toInt(&expaux[0])) + 2048);
cmp_index_ref_load = ((1 * Fr_toInt(&expaux[0])) + 2048);
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&expaux[0])) + 2048)]].signalStart + ((1 * Fr_toInt(&lvar[3])) + 0)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
KeccakF1600_4_run(mySubcomponents[cmp_index_ref],ctx);
...
Fr_mul(&expaux[1],&ctx->signalValues[ctx->componentMemory[mySubcomponents[2063]].signalStart + ((1 * ((8 * Fr_toInt(&lvar[2])) + Fr_toInt(&lvar[4]))) + 0)],&expaux[2]); // line circom 47
...
Keccak_256_bytes_5_create(mySignalStart+2112,0+ctx_index+1,ctx,new_cmp_name,myId);
...
{
{{
Fr_eq(&expaux[0],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 0)],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 2080)]); // line circom 15
}}
