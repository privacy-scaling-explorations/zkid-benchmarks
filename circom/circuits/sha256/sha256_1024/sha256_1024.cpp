...
uint get_main_input_signal_no() {return 1056;}

uint get_total_signal_no() {return 1379809;}

uint get_number_of_components() {return 12916;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 303153;}
...
H_1_create(mySignalStart+1367904,11849+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 11849+ctx_index+1;
}
{
std::string new_cmp_name = "iv[1]";
H_2_create(mySignalStart+1367936,11850+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 11850+ctx_index+1;
}
{
std::string new_cmp_name = "iv[2]";
H_3_create(mySignalStart+1367968,11851+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2] = 11851+ctx_index+1;
}
{
std::string new_cmp_name = "iv[3]";
H_4_create(mySignalStart+1368000,11852+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[3] = 11852+ctx_index+1;
}
{
std::string new_cmp_name = "iv[4]";
H_5_create(mySignalStart+1368032,11853+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[4] = 11853+ctx_index+1;
}
{
std::string new_cmp_name = "iv[5]";
H_6_create(mySignalStart+1368064,11854+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[5] = 11854+ctx_index+1;
}
{
std::string new_cmp_name = "iv[6]";
H_7_create(mySignalStart+1368096,11855+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[6] = 11855+ctx_index+1;
}
{
std::string new_cmp_name = "iv[7]";
H_8_create(mySignalStart+1368128,11856+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[7] = 11856+ctx_index+1;
}
{
uint aux_create = 8;
int aux_cmp_num = 0+ctx_index+1;
uint csoffset = mySignalStart+17152;
...
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[2])) + 8448)];
// load src
// end load src
...
{
PFrElement aux_dest = &signalValues[mySignalStart + 16640];
// load src
// end load src
Fr_copy(aux_dest,&circuitConstants[2]);
}
...
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&expaux[0])) + 8448)];
// load src
...
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[20]); // line circom 21
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[3];
// load src
...
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&expaux[0])) + 8448)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
Sha256Compression_18_run(mySubcomponents[cmp_index_ref],ctx);
...
cmp_index_ref_load = 24;
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[24]].signalStart + (((32 * Fr_toInt(&lvar[2])) + (1 * Fr_toInt(&lvar[3]))) + 0)]);
}
{
PFrElement aux_dest = &lvar[3];
// load src
...
ctx->componentMemory[coffset].componentName = componentName;
ctx->componentMemory[coffset].idFather = componentFather;
ctx->componentMemory[coffset].subcomponents = new uint[1057]{0};
}
...
Sha256_19_create(mySignalStart+10560,1056+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1024] = 1056+ctx_index+1;
}
{
uint aux_create = 1025;
int aux_cmp_num = 0+ctx_index+1;
...
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = ((1 * Fr_toInt(&lvar[1])) + 1025);
...
cmp_index_ref_load = 1024;
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[1024]].signalStart + ((1 * ((Fr_toInt(&lvar[1]) * 8) + Fr_toInt(&lvar[2]))) + 0)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
...
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 0)];
// load src
cmp_index_ref_load = ((1 * Fr_toInt(&lvar[1])) + 1025);
cmp_index_ref_load = ((1 * Fr_toInt(&lvar[1])) + 1025);
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[1])) + 1025)]].signalStart + 0]);
}
{
PFrElement aux_dest = &lvar[1];
// load src
...
{
std::string new_cmp_name = "sha256";
Sha256Bytes_21_create(mySignalStart+1088,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
uint cmp_index_ref = 0;
...
// load src
// end load src
Fr_copyn(aux_dest,&signalValues[mySignalStart + 32],1024);
}
// need to run sub component
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1024;
...
{
{{
Fr_eq(&expaux[0],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 0)],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 1056)]); // line circom 54
}}
