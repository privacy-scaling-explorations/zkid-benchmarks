...
uint get_main_input_signal_no() {return 2080;}

uint get_total_signal_no() {return 2678753;}

uint get_number_of_components() {return 25092;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 589617;}
...
H_1_create(mySignalStart+2655584,23001+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 23001+ctx_index+1;
}
{
std::string new_cmp_name = "iv[1]";
H_2_create(mySignalStart+2655616,23002+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 23002+ctx_index+1;
}
{
std::string new_cmp_name = "iv[2]";
H_3_create(mySignalStart+2655648,23003+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2] = 23003+ctx_index+1;
}
{
std::string new_cmp_name = "iv[3]";
H_4_create(mySignalStart+2655680,23004+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[3] = 23004+ctx_index+1;
}
{
std::string new_cmp_name = "iv[4]";
H_5_create(mySignalStart+2655712,23005+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[4] = 23005+ctx_index+1;
}
{
std::string new_cmp_name = "iv[5]";
H_6_create(mySignalStart+2655744,23006+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[5] = 23006+ctx_index+1;
}
{
std::string new_cmp_name = "iv[6]";
H_7_create(mySignalStart+2655776,23007+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[6] = 23007+ctx_index+1;
}
{
std::string new_cmp_name = "iv[7]";
H_8_create(mySignalStart+2655808,23008+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[7] = 23008+ctx_index+1;
}
{
uint aux_create = 8;
int aux_cmp_num = 0+ctx_index+1;
uint csoffset = mySignalStart+33536;
...
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[2])) + 16640)];
// load src
// end load src
...
{
PFrElement aux_dest = &signalValues[mySignalStart + 33024];
// load src
// end load src
Fr_copy(aux_dest,&circuitConstants[2]);
}
...
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&expaux[0])) + 16640)];
// load src
...
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[31]); // line circom 21
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[3];
// load src
...
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&expaux[0])) + 16640)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
Sha256Compression_18_run(mySubcomponents[cmp_index_ref],ctx);
...
cmp_index_ref_load = 40;
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[40]].signalStart + (((32 * Fr_toInt(&lvar[2])) + (1 * Fr_toInt(&lvar[3]))) + 0)]);
}
{
PFrElement aux_dest = &lvar[3];
// load src
...
ctx->componentMemory[coffset].componentName = componentName;
ctx->componentMemory[coffset].idFather = componentFather;
ctx->componentMemory[coffset].subcomponents = new uint[2081]{0};
}
...
uint csoffset = mySignalStart+2368;
uint aux_dimensions[1] = {2048};
...
Sha256_19_create(mySignalStart+20800,2080+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2048] = 2080+ctx_index+1;
}
{
uint aux_create = 2049;
int aux_cmp_num = 0+ctx_index+1;
...
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = ((1 * Fr_toInt(&lvar[1])) + 2049);
...
cmp_index_ref_load = 2048;
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[2048]].signalStart + ((1 * ((Fr_toInt(&lvar[1]) * 8) + Fr_toInt(&lvar[2]))) + 0)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
...
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 0)];
// load src
cmp_index_ref_load = ((1 * Fr_toInt(&lvar[1])) + 2049);
cmp_index_ref_load = ((1 * Fr_toInt(&lvar[1])) + 2049);
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[1])) + 2049)]].signalStart + 0]);
}
{
PFrElement aux_dest = &lvar[1];
// load src
...
ctx->componentMemory[coffset].signalStart = soffset;
ctx->componentMemory[coffset].inputCounter = 2080;
ctx->componentMemory[coffset].componentName = componentName;
ctx->componentMemory[coffset].idFather = componentFather;
ctx->componentMemory[coffset].subcomponents = new uint[1]{0};
}
...
{
std::string new_cmp_name = "sha256";
Sha256Bytes_21_create(mySignalStart+2112,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
uint cmp_index_ref = 0;
...
// load src
// end load src
Fr_copyn(aux_dest,&signalValues[mySignalStart + 32],2048);
}
// need to run sub component
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 2048;
...
{
{{
Fr_eq(&expaux[0],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 0)],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 2080)]); // line circom 54
}}
