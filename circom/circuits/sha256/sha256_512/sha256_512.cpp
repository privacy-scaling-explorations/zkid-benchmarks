...
uint get_total_signal_no() {return 730337;}

uint get_number_of_components() {return 6828;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 159921;}

uint get_size_of_constants() {return 143;}
...
H_1_create(mySignalStart+724064,6273+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 6273+ctx_index+1;
}
{
std::string new_cmp_name = "iv[1]";
H_2_create(mySignalStart+724096,6274+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 6274+ctx_index+1;
}
{
std::string new_cmp_name = "iv[2]";
H_3_create(mySignalStart+724128,6275+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2] = 6275+ctx_index+1;
}
{
std::string new_cmp_name = "iv[3]";
H_4_create(mySignalStart+724160,6276+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[3] = 6276+ctx_index+1;
}
{
std::string new_cmp_name = "iv[4]";
H_5_create(mySignalStart+724192,6277+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[4] = 6277+ctx_index+1;
}
{
std::string new_cmp_name = "iv[5]";
H_6_create(mySignalStart+724224,6278+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[5] = 6278+ctx_index+1;
}
{
std::string new_cmp_name = "iv[6]";
H_7_create(mySignalStart+724256,6279+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[6] = 6279+ctx_index+1;
}
{
std::string new_cmp_name = "iv[7]";
H_8_create(mySignalStart+724288,6280+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[7] = 6280+ctx_index+1;
}
{
uint aux_create = 8;
int aux_cmp_num = 0+ctx_index+1;
uint csoffset = mySignalStart+8960;
...
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[2])) + 4352)];
// load src
// end load src
...
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&expaux[0])) + 4352)];
// load src
...
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[28]); // line circom 21
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[3];
// load src
...
cmp_index_ref_load = 16;
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[16]].signalStart + (((32 * Fr_toInt(&lvar[2])) + (1 * Fr_toInt(&lvar[3]))) + 0)]);
}
{
PFrElement aux_dest = &lvar[3];
// load src
...
ctx->componentMemory[coffset].componentName = componentName;
ctx->componentMemory[coffset].idFather = componentFather;
ctx->componentMemory[coffset].subcomponents = new uint[545]{0};
}
...
Sha256_19_create(mySignalStart+5440,544+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[512] = 544+ctx_index+1;
}
{
uint aux_create = 513;
int aux_cmp_num = 0+ctx_index+1;
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[39]); // line circom 20
while(Fr_isTrue(&expaux[0])){
{
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[39]); // line circom 27
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[2];
// load src
...
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = ((1 * Fr_toInt(&lvar[1])) + 513);
...
cmp_index_ref_load = 512;
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[512]].signalStart + ((1 * ((Fr_toInt(&lvar[1]) * 8) + Fr_toInt(&lvar[2]))) + 0)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
...
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 0)];
// load src
cmp_index_ref_load = ((1 * Fr_toInt(&lvar[1])) + 513);
cmp_index_ref_load = ((1 * Fr_toInt(&lvar[1])) + 513);
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[1])) + 513)]].signalStart + 0]);
}
{
PFrElement aux_dest = &lvar[1];
// load src
...
{
std::string new_cmp_name = "sha256";
Sha256Bytes_21_create(mySignalStart+576,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
uint cmp_index_ref = 0;
...
{
{{
Fr_eq(&expaux[0],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 0)],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 544)]); // line circom 54
}}
