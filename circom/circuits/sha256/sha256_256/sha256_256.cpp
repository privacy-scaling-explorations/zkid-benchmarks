...
uint get_total_signal_no() {return 405601;}

uint get_number_of_components() {return 3784;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 88305;}
...
H_1_create(mySignalStart+402144,3485+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 3485+ctx_index+1;
}
{
std::string new_cmp_name = "iv[1]";
H_2_create(mySignalStart+402176,3486+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 3486+ctx_index+1;
}
{
std::string new_cmp_name = "iv[2]";
H_3_create(mySignalStart+402208,3487+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2] = 3487+ctx_index+1;
}
{
std::string new_cmp_name = "iv[3]";
H_4_create(mySignalStart+402240,3488+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[3] = 3488+ctx_index+1;
}
{
std::string new_cmp_name = "iv[4]";
H_5_create(mySignalStart+402272,3489+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[4] = 3489+ctx_index+1;
}
{
std::string new_cmp_name = "iv[5]";
H_6_create(mySignalStart+402304,3490+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[5] = 3490+ctx_index+1;
}
{
std::string new_cmp_name = "iv[6]";
H_7_create(mySignalStart+402336,3491+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[6] = 3491+ctx_index+1;
}
{
std::string new_cmp_name = "iv[7]";
H_8_create(mySignalStart+402368,3492+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[7] = 3492+ctx_index+1;
}
{
uint aux_create = 8;
int aux_cmp_num = 0+ctx_index+1;
...
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[2])) + 2304)];
// load src
// end load src
...
{
PFrElement aux_dest = &signalValues[mySignalStart + 4352];
// load src
// end load src
Fr_copy(aux_dest,&circuitConstants[2]);
}
...
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&expaux[0])) + 2304)];
// load src
...
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[6]); // line circom 21
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[3];
// load src
...
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&expaux[0])) + 2304)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
Sha256Compression_18_run(mySubcomponents[cmp_index_ref],ctx);
...
cmp_index_ref_load = 12;
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[12]].signalStart + (((32 * Fr_toInt(&lvar[2])) + (1 * Fr_toInt(&lvar[3]))) + 0)]);
}
{
PFrElement aux_dest = &lvar[3];
// load src
...
ctx->componentMemory[coffset].componentName = componentName;
ctx->componentMemory[coffset].idFather = componentFather;
ctx->componentMemory[coffset].subcomponents = new uint[289]{0};
}
...
Sha256_19_create(mySignalStart+2880,288+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[256] = 288+ctx_index+1;
}
{
uint aux_create = 257;
int aux_cmp_num = 0+ctx_index+1;
...
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = ((1 * Fr_toInt(&lvar[1])) + 257);
...
cmp_index_ref_load = 256;
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[256]].signalStart + ((1 * ((Fr_toInt(&lvar[1]) * 8) + Fr_toInt(&lvar[2]))) + 0)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
...
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 0)];
// load src
cmp_index_ref_load = ((1 * Fr_toInt(&lvar[1])) + 257);
cmp_index_ref_load = ((1 * Fr_toInt(&lvar[1])) + 257);
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[1])) + 257)]].signalStart + 0]);
}
{
PFrElement aux_dest = &lvar[1];
// load src
...
{
std::string new_cmp_name = "sha256";
Sha256Bytes_21_create(mySignalStart+320,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
uint cmp_index_ref = 0;
...
{
{{
Fr_eq(&expaux[0],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 0)],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 288)]); // line circom 54
}}
