...
public enum MoproError {
    ...
    case Plonky2Error(message: String)
...
public struct FfiConverterTypeMoproError: FfiConverterRustBuffer {
    ...
    public static func write(_ value: MoproError, into buf: inout [UInt8]) {
        ...
        case .Plonky2Error(_ /* message is ignored*/):
...
public func deserializeInputs(inputs: Data) -> [String] {
    return try!  FfiConverterSequenceString.lift(try! rustCall() {
    uniffi_mopro_bindings_fn_func_deserialize_inputs(
        FfiConverterData.lower(inputs),$0
    )
})
}
public func generateFibonacciProof(proverDataPath: String, inputs: [String: [String]])throws  -> GenerateProofResult {
    return try  FfiConverterTypeGenerateProofResult.lift(try rustCallWithError(FfiConverterTypeMoproError.lift) {
    uniffi_mopro_bindings_fn_func_generate_fibonacci_proof(
        FfiConverterString.lower(proverDataPath),
        FfiConverterDictionaryStringSequenceString.lower(inputs),$0
    )
})
}
public func generateSha256Proof()throws  -> GenerateProofResult {
    return try  FfiConverterTypeGenerateProofResult.lift(try rustCallWithError(FfiConverterTypeMoproError.lift) {
    uniffi_mopro_bindings_fn_func_generate_sha256_proof($0
    )
})
}
public func serializeInputs(inputs: [String]) -> Data {
    return try!  FfiConverterData.lift(try! rustCall() {
    uniffi_mopro_bindings_fn_func_serialize_inputs(
        FfiConverterSequenceString.lower(inputs),$0
    )
})
}
public func sha256RoundtripBench()throws  -> [String] {
    return try  FfiConverterSequenceString.lift(try rustCallWithError(FfiConverterTypeMoproError.lift) {
    uniffi_mopro_bindings_fn_func_sha256_roundtrip_bench($0
    )
})
}
public func verifyFibonacciProof(verifierDataPath: String, proof: Data, inputs: Data)throws  -> Bool {
    return try  FfiConverterBool.lift(try rustCallWithError(FfiConverterTypeMoproError.lift) {
    uniffi_mopro_bindings_fn_func_verify_fibonacci_proof(
        FfiConverterString.lower(verifierDataPath),
        FfiConverterData.lower(proof),
        FfiConverterData.lower(inputs),$0
    )
})
}
public func verifySha256Proof(verifierDataPath: String, proof: Data, inputs: Data)throws  -> Bool {
    return try  FfiConverterBool.lift(try rustCallWithError(FfiConverterTypeMoproError.lift) {
    uniffi_mopro_bindings_fn_func_verify_sha256_proof(
        FfiConverterString.lower(verifierDataPath),
        FfiConverterData.lower(proof),
        FfiConverterData.lower(inputs),$0
    )
...
private var initializationResult: InitializationResult = {
    ...
    if (uniffi_mopro_bindings_checksum_func_deserialize_inputs() != 62127) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_mopro_bindings_checksum_func_generate_fibonacci_proof() != 50262) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_mopro_bindings_checksum_func_generate_sha256_proof() != 2259) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_mopro_bindings_checksum_func_serialize_inputs() != 47117) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_mopro_bindings_checksum_func_sha256_roundtrip_bench() != 27587) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_mopro_bindings_checksum_func_verify_fibonacci_proof() != 15601) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_mopro_bindings_checksum_func_verify_sha256_proof() != 8511) {
        return InitializationResult.apiChecksumMismatch
    }
